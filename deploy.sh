...
cd apps/web
NEXT_PUBLIC_AGENT_URL="${AGENT_URL}" vercel --prod --yes
cd ../..
...
echo ""
echo "Next steps:"
echo "  1. Set NEXT_PUBLIC_AGENT_URL=${AGENT_URL} in Vercel env vars"
echo "  2. Set GCP_PROJECT_ID and FIRESTORE_COLLECTION in Vercel env vars"
echo "  3. Redeploy web if env vars changed: cd apps/web && vercel --prod"
